...
export class StudentService {
	...
	getRealStudents(page): Promise<any> {
		return this.userService.getToken().then(token =>{
			...
			// getting teachers from the backend
	 		this.realStudentsUrl = `http://192.168.1.78:8082/UnibookHsisRest/students/tms?token=${token}&subModuleId=1000048%2C1000047%2C1000058%2C1000059%2C1000057%2C1000046&page=${page}&pageSize=50`;
	...
	mapStudents(response:Response, token: string): Student[]{
		console.log('mapStudents response: ', response.json());
