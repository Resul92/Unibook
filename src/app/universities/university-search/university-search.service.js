...
var UniversitySearchService = (function () {
    function UniversitySearchService(http) {
        this.http = http;
    }
    UniversitySearchService.prototype.search = function (term) {
        return this.http
            .get("app/universities/?name=" + term)
            .map(function (r) { return r.json().data; });
    };
    return UniversitySearchService;
}());
UniversitySearchService = __decorate([
    core_1.Injectable(),
